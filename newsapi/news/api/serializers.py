...
class ArticleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Article
        exclude = ("id",) #get all field less the fileds in te list
        #fields = "__all__" #all the fields of the model
        #fields = ("title", "author", "body") #only some fileds
    ...
    def validate_title(self, value):
        if len(value) < 60:
            raise serializers.ValidationError("The Title must to be at least 60 chars long")
        return value
